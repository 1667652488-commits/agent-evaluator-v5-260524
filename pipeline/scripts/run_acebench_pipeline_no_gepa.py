...
RESULTS_DIR = PROJECT_ROOT / "results" / "no_gepa"
...
def generate_evaluator(coldstart_results, summary):
    ...
    optimizer_config = {
        "name": "ACEBench_Optimizer_v1",
        "created_from": "cold_start",
        "strategy": "rule_based_prompt_patching",
        "gepa_enabled": False,
...
def generate_summary_report(coldstart_summary, round_results):
    ...
    report = {
        ...
        "gepa_enabled": False,
        "execution_mode": "multi_step_sandbox",
...
def main():
    print("=" * 70)
    print("ACEBench 飞轮执行（多步沙箱版 | GEPA: 关闭）")
    print("=" * 70)
    print(f"模型: {MODEL}")
